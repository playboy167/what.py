...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/playboy167?tab=repositories"])
...
def notice():
	...
	subprocess.check_output(["am", "start", "https://m.me/PLAY BOY"])
 
def irfan():
	
	
	runtxt("\n\033[0;91m🧞‍This tool is offical for PLAY BOY")
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/playboy167/offline-approval.txt/tree/main').text
			if basesplit in plr:
				key = basesplit
...
░       ░ ░           ░                                      ░                                            
\033[1;90m═══════════════════════════════════════════════════════════
\033[1;94m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : PLAY BOY
\033[1;95m [\033[1;94m✯\033[1;91m] \033[1;92mWHATSUP  : +8801979526394
\033[1;93m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB      : @playboy167
\033[1;97m [\033[1;94m✯\033[1;91m] \033[1;92mWARNING  : DONT TRY TO COPPY MY SCRYPT
\033[1;90m═══════════════════════════════════════════════════════════
    """)
		print("%s [%s•%s] %sTOOL NAME : %sPLAY BOY❌ PROO CLONER❌"%(G,R,G,B,G))
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;91m[PLAY-CP] %s|%s\033[0;97m         "%(uid, pw))
